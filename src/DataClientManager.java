 ...
 * @author Ricky K
 */
public class DataClientManager extends javax.swing.JFrame {

    /**
     * Creates new form DataClientManager
     */
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id_Client", "Username", "Password", "Jenis Kelamin", "Status"
            }
        ) {
        ...
        jLabel7.setText("Hapus Client");

        jLabel8.setText("Id_Client");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataClientManager.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataClientManager().setVisible(true);
            }
        });
    }
